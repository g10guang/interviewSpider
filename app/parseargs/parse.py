...
class ParseArgs:
    ...
    def _parse(self):
        ...
        parser.add_argument('-u', dest='url', default='', metavar='http://g10guang.com', type=str, help='输入爬取的网站的 url')
        parser.add_argument('-f', dest='logfile', default='./spider_log.txt', metavar='log.txt', type=str,
                            help='日志输出文件')
        ...
        parser.add_argument('-dbfile', dest='dbfile', metavar='./spider.db', default='spider.db', type=str,
                            help='sqlite3 数据保存文件')
        parser.add_argument('--key', dest='key', default='', metavar='keyword', type=str, help='搜索关键字')
